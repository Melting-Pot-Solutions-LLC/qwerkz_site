...
jQuery( document ).ready( function ( $ ) {
    ...
    $( '#fancy-inputs input[type="text"], #fancy-inputs input[type="email"], #fancy-inputs textarea' ).blur( function () {
...
{
    $('.home-page .overlay, .single-page .overlay').height(window.innerHeight + 'px');
}
